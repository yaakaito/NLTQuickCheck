...
describe(@"Test Runner", ^{
    context(@"all successful test case", ^{
        ...
        context(@"and run 10 cases", ^{
            ...
            it(@"should has 10 success reports", ^{
    ...
    context(@"failure at 3rd , 4th and 5th test case", ^{
        ...
        context(@"and run 6 cases ", ^{
            ...
            it(@"should 4th report is failure (needsRetry=YES,retryCount=1,isException=NO)", ^{
            ...
            it(@"should 5th report is failure (needsRetry=NO,retryCount=2,isException=NO)", ^{
            ...
            it(@"equals 3rd, 4th and 5th arguments", ^{
            ...
            it(@"should 6th report is success", ^{
